  ...
  return (
    <section className="py-12 bg-white" ref={ref}>
      <div className="container mx-auto px-6">
        ...
        <p className="text-center sm:text-xl text-gray-600 text-base pb-8">
          Fraterny is built on the belief that <span className="font-extrabold text-terracotta">success</span> and <span className="font-extrabold text-terracotta">self discovery</span> can be accelerated exponentially...
        </p>
