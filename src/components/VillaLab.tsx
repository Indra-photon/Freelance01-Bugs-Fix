...
// //           <h2 className="text-center sm:text-left sm:text-4xl md:text-5xl lg:text-6xl font-playfair text-navy mb-3 sm:mb-4 text-4xl">
// //             The Villa Lab
// //           </h2>

// //           <p className="text-center sm:text-left sm:text-xl text-gray-600 text-base">
...
//         {/* FIXED: Added text-center sm:text-right for consistent "see more" link alignment */}
